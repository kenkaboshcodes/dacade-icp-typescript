...
import { idlFactory } from './canister_tenant_management.did.js';
export { idlFactory } from './canister_tenant_management.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_TENANT_MANAGEMENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canister_tenant_management.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canister_tenant_management canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canister_tenant_management.did.js")._SERVICE>}
 */
export const canister_tenant_management = createActor(canisterId);
